...
func (c *greeterClient) SayRepeatHello(ctx context.Context, in *RepeatHelloRequest, opts ...grpc.CallOption) (Greeter_SayRepeatHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/helloworld.Greeter/SayRepeatHello", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedGreeterServer) SayRepeatHello(*RepeatHelloRequest, Greeter_SayRepeatHelloServer) error {
